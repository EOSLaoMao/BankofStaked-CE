...
cleos -u $API push action bankofstaked setplan '{"price": "0.5000 EOS", "cpu": "20.0000 EOS", "net": "0.0000 EOS", "duration": 10080, "is_free": false}' -p bankofstaked
cleos -u $API push action bankofstaked setplan '{"price": "1.0000 EOS", "cpu": "50.0000 EOS", "net": "0.0000 EOS", "duration": 10080, "is_free": false}' -p bankofstaked
cleos -u $API push action bankofstaked setplan '{"price": "2.0000 EOS", "cpu": "120.0000 EOS", "net": "0.0000 EOS", "duration": 10080, "is_free": false}' -p bankofstaked
